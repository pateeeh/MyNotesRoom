...
import com.example.mynotesroom.databinding.ActivityNoteAddUpdateBinding
import com.example.mynotesroom.helper.DataHelper
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.acton_delete -> showAlertDialog(ALERT_DIALOG_DELETE)
        ...
        with(alertDialogBuilder) {
            ...
            setPositiveButton(getString(R.string.yes)) { _, _ ->
                if (!isDialogClose) {
                    ...
                    showToast(getString(R.string.deleteed))
                }
                finish()
            }
